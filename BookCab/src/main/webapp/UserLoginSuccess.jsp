...
<div class = "alignment">
	...
	<c:if test="${user.userName eq username and user.password eq password }">
...
<div >
	...
	<c:if test="${user.userName ne username and user.password ne password }">
		<h1>Invaild Username or password</h1>
	</c:if>
	</c:when>
	<c:otherwise>
	<h1>Invaild Username or password</h1>
